  ...
  return (
    <div className="pt-48 pb-32 px-6 max-w-7xl mx-auto space-y-48 animate-in">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
        <div className="space-y-12">
          <div className="space-y-4">
            ...
            <h3 className="text-5xl font-bold font-space">Optimize Lead <br /> <span className="text-[#00FF41]">Conversion.</span></h3>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
        <div className="lg:order-2 space-y-12">
          <div className="space-y-4">
            ...
            <h3 className="text-5xl font-bold font-space">Automated Patient <br /> <span className="text-[#00FF41]">Management.</span></h3>
      ...
      <section className="text-center py-20 neumorph-card p-12 space-y-8">
        <h3 className="text-3xl md:text-5xl font-bold font-space">Ready to transform your industry?</h3>
