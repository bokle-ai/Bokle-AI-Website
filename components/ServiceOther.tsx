    ...
    <div className="pt-20 pb-32 px-6 max-w-7xl mx-auto animate-in space-y-40">
      <header className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center min-h-[70vh]">
        <div className="space-y-10 order-2 lg:order-1">
          ...
          <h1 className="text-6xl md:text-9xl font-black font-space tracking-tighter italic leading-none">
            CUSTOM <br />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/5">
        <div className="bg-[#030804] p-16 space-y-8">
          ...
          <h3 className="text-3xl font-bold font-space">Neural Workflow Sync</h3>
        ...
        <div className="bg-[#030804] p-16 space-y-8">
          <div className="w-16 h-1 bg-[#00FF41]"></div>
          <h3 className="text-3xl font-bold font-space">Sentiment Data Mining</h3>
      ...
      <div className="premium-glass p-20 rounded-[60px] text-center space-y-12 border-[#00FF41]/20">
        <h2 className="text-4xl font-bold font-space">If it involves data, <span className="text-[#00FF41]">we can glide it.</span></h2>
